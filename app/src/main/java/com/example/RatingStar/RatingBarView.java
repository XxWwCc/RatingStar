...
public class RatingBarView extends LinearLayout {
    ...
    private int mPaddingAbout;
    private int mPaddingUpDown;
    private int mMarginAbout;
    private int mMarginUpDown;
    ...
    public RatingBarView(Context context, AttributeSet attrs) {
        ...
        mPaddingAbout = ta.getInteger(R.styleable.RatingBarView_paddingAbout, 0);
        mPaddingUpDown = ta.getInteger(R.styleable.RatingBarView_paddingUpDown, 0);
        mMarginAbout = ta.getInteger(R.styleable.RatingBarView_marginAbout, 10);
        mMarginUpDown = ta.getInteger(R.styleable.RatingBarView_marginUpDown, 0);
    ...
    private ImageView getStarImageView(Context context, AttributeSet attrs) {
        ...
        lp.setMargins(mMarginAbout, mMarginUpDown, mMarginAbout, mMarginUpDown);
        imageView.setLayoutParams(lp);

        // TODO:you can change gap between two stars use the padding
//        imageView.setPadding(0, 0, 40, 0);
        imageView.setPadding(mPaddingAbout, mPaddingUpDown, mPaddingAbout, mPaddingUpDown);
